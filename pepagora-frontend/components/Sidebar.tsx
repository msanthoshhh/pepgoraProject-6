...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed top-0 left-0 h-full w-64 bg-gradient-to-b from-gray-900 to-gray-800 text-white shadow-2xl z-10 flex flex-col">
      {/* Logo */}
      <div className="p-6 border-b border-gray-700">
        <Link href="/dashboard" className="flex items-center space-x-2">
          <div className="w-10 h-10 bg-red-600 rounded-lg flex items-center justify-center">
        ...
        {navItems.map(({ href, label, icon }) => (
          <Link
            ...
            className={`flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors duration-200 group
              ${pathname === href ? 'bg-gray-700 text-white' : 'hover:bg-gray-700 text-gray-300'}`}
          >
        ...
        {userRole === 'admin' && (
          <div className="pt-4 mt-4 border-t border-gray-700">
            ...
            <Link
              href="/AdminAccess"
              className={`flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors duration-200 group
                ${pathname === '/AdminAccess' ? 'bg-gray-700 text-white' : 'hover:bg-gray-700 text-gray-300'}`}
            >
              <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
              </svg>
            ...
            <Link
              href="/viewUser"
              className={`flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors duration-200 group
                ${pathname === '/viewUser' ? 'bg-gray-700 text-white' : 'hover:bg-gray-700 text-gray-300'}`}
            >
              <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" />
              </svg>
